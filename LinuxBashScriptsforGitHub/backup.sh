...
# Create `/var/backup` if it doess't exist
mkdir -p /var/backup

# Create new  `/var/backup/home.tar`
tar cvf /var/backup/home.tar /home 

# Moves the file `/var/backup/home.tar` to `/var/backup/home.04082021.tar`
...
# List all files in `/var/backup` , including file sizes, and save the output to `/var/backup/file_report_text`. 
